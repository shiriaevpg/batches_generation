...
TestT sim_annealing4(orders, 10000, 0.05, 0.05, 0.45, 0.45);
TestT sim_annealing5(orders, 10000, 0.1, 0.1, 0.4, 0.4, 2);
...
int main(int argc, char** argv) {
  ...
  Pipeline(sim_annealing1, "Отжиг_кол-во_итераций=1000,вероятности=0.1,0.1,0.4,0.4", 0);
  Pipeline(sim_annealing2, "Отжиг_кол-во_итераций=10000,вероятности=0.1,0.1,0.4,0.4", 1);
  Pipeline(sim_annealing3, "Отжиг_кол-во_итераций=10000,вероятности=0.2,0.2,0.3,0.3", 2);
  Pipeline(sim_annealing4, "Отжиг_кол-во_итераций=10000,вероятности=0.05,0.05,0.45,0.45", 3);
  Pipeline(sim_annealing5, "Отжиг_кол-во_итераций=10000,вероятности=0.1,0.1,0.4,0.4,темпарутра=2", 4);
}